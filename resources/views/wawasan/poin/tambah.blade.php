                    ...
                    <div class="tab-content">
                        <form role="form">
                            <div class="form-group label-floating">
                                <label class="control-label">Nama Poin Wawasan</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="form-group label-floating">
                                <label class="control-label">Bobot Poin Wawasan</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="form-group label-floating">
                                <label class="control-label">Deskripsi Poin Wawasan</label>
