                    ...
                    <table class="table table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Nama Wawasan 1</td>
                                <td>Deskripsi Wawasan 1</td>
                                <td>0.87</td>
                                <td class="td-actions text-center">
                                    <a href="{{route('wawasan.lihat',1)}}">
