                    ...
                    <div class="tab-content">
                        <form role="form">
                            <div class="form-group label-floating">
                                <label class="control-label">Nama Output</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="form-group label-floating">
                                <label class="control-label">Bobot Output</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="form-group label-floating">
                                <label class="control-label">Deskripsi Output</label>
